    ...
    return Padding(
      ...
      child: Column(
        children: <Widget>[
          ...
          InfoTile(label: LocaleKeys.kadr_label.tr(), labelInfo: branch.kadrs!.map((kadr) => kadr.fullName).toList().join(',\n')),
          InfoTile(label: LocaleKeys.recruiter_text.tr(), labelInfo: branch.recruiters!.map((kadr) => kadr.fullName).toList().join(',\n')),
